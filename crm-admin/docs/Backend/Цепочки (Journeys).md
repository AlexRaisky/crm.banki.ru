...
Хранение **цепочек-схем** — блок-схем коммуникаций, которые рисуют в [[Flow Builder (цепочки)]]. Здесь только модель и CRUD; превращение схемы в строки процессных таблиц — [Материализация (Flow)](Материализация%20(Flow).md).
...
[Материализация (Flow)](Материализация%20(Flow).md) · [[Flow Builder (цепочки)]] · [[Таблицы приложения]] · [[Слой A (flow)]] · [[Справочники шаблонов]] · [Обзор бэкенда](Обзор%20бэкенда.md) · [[Безопасность и RBAC]] · [[REST API]]

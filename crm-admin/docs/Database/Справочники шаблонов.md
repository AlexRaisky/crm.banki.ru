...
Раньше эти списки были захардкожены в `wizard.js`; теперь ведутся в БД и пополняются без релиза (`DictionaryService`, [[REST API]]). Все три таблицы имеют одинаковую структуру:

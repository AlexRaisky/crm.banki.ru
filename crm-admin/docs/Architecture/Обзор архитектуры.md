...
flowchart TB
    ...
    subgraph App["Spring Boot 3.3 · crm-admin.jar"]
        ...
        subgraph Ctrl["REST /api/**"]
            ...
            C2["Journey · Flow"]
            C3["PromoPlan · SmsCheckReport<br/>ReportConnection"]
        ...
        subgraph Svc["Сервисы"]
            ...
            S4["UserService · RoleService<br/>PromoPlanService · SmsCheckReportService<br/>DbConnectionService"]
    ...
    subgraph OurDB["PostgreSQL 16 — наша БД (по одной на контур)"]
        ...
        T3["app.*: users · role · role_section<br/>journeys · promo_plan · panel_settings<br/>db_connection"]

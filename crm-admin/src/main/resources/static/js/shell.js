...
const I18N_EN = {
  ...
  "Как собирается source":"How the source is assembled",
  "Части разделяются подчёркиванием:":"Parts are joined with underscores:",
  "Тип рассылки":"Mailing type", "Тип рассылки:":"Mailing type:",
  "service добавляет приписку service- в самое начало; adv и info название не меняют.":"service prepends service- to the whole name; adv and info leave it unchanged.",
  "Коммуникация КЦ:":"Contact centre communication:",
  "флаг «Это не голосовая коммуникация для КЦ?» ставит первой частью contact, а выбранный канал уходит приставкой в уникальное название.":"the \"Not a voice communication for the contact centre?\" flag makes contact the first part, and the selected channel becomes a prefix of the unique name.",
  "Не выбран":"Not selected",
  "Сервисная рассылка начинается с приписки service-; для adv и info название не меняется.":"A service campaign starts with the service- prefix; for adv and info the name is unchanged.",
  "Это не голосовая коммуникация для КЦ?":"Not a voice communication for the contact centre?",
  "Первая часть станет contact, а выбранный канал уйдёт приставкой в уникальное название (например sms-).":"The first part becomes contact, and the selected channel is prepended to the unique name (e.g. sms-).",
